...
export function WizardHeader() {
  const { assignment } = useAssignmentWizard();

  if (!assignment) return null;

  return <header className="h-20 border-b border-[#ebebeb] px-10 flex items-center justify-between bg-white z-10 shrink-0">
